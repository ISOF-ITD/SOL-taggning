...
describe Sol do
  ...
  describe '#process' do
    it "processes a few entries" do
      ...
      expect(out).to eq '<head><placeName>Hurva</placeName></head> <P><locale>sn</locale>, <locale>tätort</locale>, <region type="härad">Frosta hd</region>, <region type="landskap">Skåne</region>'
    end
  end
end
